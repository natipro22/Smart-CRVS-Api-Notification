...
{
    public class DeathRegistrarEntityConfiguration : IEntityTypeConfiguration<DeathRegistrar>
    {
        public void Configure(EntityTypeBuilder<DeathRegistrar> builder)
        {
